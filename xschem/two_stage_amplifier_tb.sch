...
op
write two_stage_amplifier_tb.raw
...
C {vsource.sym} 180 430 0 0 {name=V6 value="ac 0.5 pulse(0 10m 1u 1p 1p 1u 10u)" savecurrent=true}
...
C {vsource.sym} 470 430 2 0 {name=V2 value="ac 0.5 pulse(0 10m 1u 1p 1p 1u 10u)" savecurrent=true}
